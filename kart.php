...
<body><div>
  ...
  <a class="navbar-brand" href="#" style="font-size:41px;">PetStore</a>
	...
	<div class="jumbotron">
	<h1 class="display-4"style="font-weight:bold;">SHOP KART</h1>
	<p class="lead"style="font-weight:bold;">All the kinds of  products for your pets is here.Just search and add to your cart</p>
	<hr class="my-4">
	<p style="font-weight:bold;">PRODUCTS FOR PET </p>
